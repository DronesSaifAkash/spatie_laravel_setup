        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    <br>
                    {{-- starts here --}}
                    <form class="form-horizontal  offset6 span8" action="{{route('admin.update_groups_data')}}" method="post"
                            onsubmit="return validateGroups()">
                            @csrf
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="groupName" id="groupName" class="input-xlarge focused"
                                            value="<?php echo stripslashes($rowsGroups->group_name ) ?>" /> <span
                                            class="help-inline error" id="groupNameError"></span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="notes"
                                            id="notes"><?php echo stripslashes($rowsGroups->notes ) ?></textarea><span
                                            class="help-inline error" id="groupNotesError"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions" style="border:none; background:none;">
                                    <button class="btn btn-primary" name="groupNameEditSubmit"
                                        type="submit">Update</button>
                                    <button class="btn btn-primary" name="groupNameAddsubmit" type="button">Cancel</button>
                                    <input type="hidden" id="groupId" name="groupId"
                                        value="<?php echo $rowsGroups->id  ?>" />
                                </div>
                            </fieldset>
                        </form>
